...
Х. Положение о блокировке анкет пользователей
  ...
  Админимтратор, применяющий инструмент блокировки, должен оставить комментарий к блокируемой анкете. В комментарии должна быть отражена причина блокировки.
