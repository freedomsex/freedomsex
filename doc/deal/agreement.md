...
1.2. Сайт является средством коммуникации для людей и представляет собой аналог почты, телефона, телеграфа, но никак не информационного сайта.
1.3. Сайт позволяет заполнять анкету на основе общедоступной информации, тем самым предоставляя информацию собеседнику о себе как о человеке и не более того;
1.4. Сайт позволяет обмениваться текстовыми сообщениями и графическими файлами между двумя пользователями в виде личной переписки.
1.5. Проект «FREEDOMSEX» представляет группа сайтов: http://freedomsex.net http://sexoo.ru http://oesex.ru http://qbsex.ru
...
3.4. Пользователь соглашается с тем, что при поступлении жалобы Модераторам сайта на сообщение отправленное Пользователем, модератор сайта получает доступ к тексту и содержанию сообщения, послужившего причиной Жалобы;
3.4. Пользователь осознаёт и соглашается с тем, что размещённая им информация может быть использована поисковыми или другими автоматизированными сервисами и иными способами.
3.5. Пользователь вправе отказаться от принятия изменений и дополнений настоящего Соглашения, производимых Администрацией сайта, что означает отказ Пользователя от использования сервисов Сайта.
...
11.1. модератором может быть любой Пользователь сайта в возрасте 18 лет и более выразивший своё желание быть Модератором;
11.2. модератор выявляет соответствие поданых Пользователями жалоб и нарушения осуществляемые другими Пользователями;
11.3. при поступлении жалобы Модератор получает доступ к тексту и содержанию сообщения послужившего причиной жалобы;

12. Учётная запись Пользователя

12.1. Учётная запись Пользователя представляет собой совокупность ячеек для сохранения персональной информации на Сайте и данные для авторизации;
...
12.3. Заполнение ячеек Учётной записи персональной информацией Пользователь осуществляет по собственному желанию, либо это происходит автоматически, на основании указанных или отправленных Пользователем данных при пользовании сайтом;
12.4. Подлинность и действительность указанной Пользователем информации Администрацией сайта не проверяется;
12.5. Изменение, удаление или иные действия связанные с содержанием персональной информации Пользователя в Учётной записи производятся лишь при обращении к Администрации сайта третьих лиц, чьи интересы затронуты содержанием указанной Пользователем информации, при явном нарушении, или при наличии постановления, подтверждающего законность таких изменений;
12.6. Учётная запись Пользователя может быть удалена автоматически через 30 дней отсутствия активности Пользователя на сайте, однако Учётная запись Пользователя  не может быть удалена по желанию Пользователя ввиду возможности доступа к Учётной записи Пользователя третьих лиц.